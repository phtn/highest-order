...
import {ALLOWED_OWNER_IDS} from '@/ctx/chat/owner'
...
const SettingsPanelContent = () => {
  ...
  const runViewTransition = useCallback((fn: () => void) => {
  ...
  const setWithTransition = useCallback(
    (fn: () => void) => {
      startTransition(() => runViewTransition(fn))
    },
    [runViewTransition],
  )
  ...
  const handleSelectConversation = useCallback(
    ...
    [selectConversation, setWithTransition],
  )
    ...
    <>
      ...
      <motion.div className='-mt-px whitespace-nowrap'>
        ...
        <div
          ...
          <div className='space-y-1 w-80 block overflow-scroll'>
            {metas.length === 0 && (
        ...
        <div
          ...
          <div className='space-y-3'>
            ...
            {/* Instructions */}
            <div className='flex h-12 items-center justify-between gap-2'>
              <Label htmlFor={`${id}-instructions`} className='font-normal'>
                Instructions
              </Label>
              <Select
            ...
            {instructionsPreset === 'custom' && (
              <div className='space-y-2'>
                ...
                <Textarea
                  ...
                  className='bg-muted border-none text-sm min-h-24'
                  value={customInstructions}
                  onChange={(e) => setCustomInstructions(e.target.value)}
                  placeholder='Example: Answer as a senior engineer. Prefer short responses with code references.'
                />
              </div>
            )}
            ...
            {/* User */}
            <div className='flex h-12 items-center justify-between gap-2'>
              <Label htmlFor={`${id}-user-select`} className='font-normal'>
                User
              </Label>
