...
export const PromptInput = ({ className, ...props }: PromptInputProps) => (
  <form className={cn("w-full divide-y overflow-hidden", className)} {...props}>
    <div className="max-w-3xl mx-auto rounded-2xl pb-4 md:pb-8 px-4">
      <div
        className={cn(
          "relative rounded-[1.25rem] bg-fade border border-foreground/10 dark:border-foreground/15 transition-colors focus-within:shadow-xl focus-within:bg-fade/50 backdrop-blur-xl focus-within:border-foreground/10 has-[:disabled]:cursor-not-allowed has-[:disabled]:opacity-50 [&:has(input:is(:disabled))_*]:pointer-events-none",
          "backdrop-blur-lg",
        )}
      >
        {props.children}
